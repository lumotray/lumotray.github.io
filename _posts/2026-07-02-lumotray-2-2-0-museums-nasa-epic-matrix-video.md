...
The update is live on the Microsoft Store and should install automatically with automatic updates enabled. Otherwise, grab it directly from [the download page](https://lumotray.com/download/blog_post_2_2_0).
